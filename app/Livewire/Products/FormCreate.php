...
class FormCreate extends Component
{
    ...
    public function submitForm(){
        ...
        $newData = $this->productService->createData($validatedData);
        ...
        if($newData){
            ...
            $this->convert_first_to_fourth = "";
            $this->convert_second_to_fourth = "";
            $this->convert_third_to_fourth = "";
    ...
    {
        return view('livewire.products.form-create');
    }
}
