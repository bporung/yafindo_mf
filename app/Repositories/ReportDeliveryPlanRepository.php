...
use App\Models\ReportDeliveryPlan as DataModel;
use Illuminate\Support\Collection;
use Auth;

interface ReportDeliveryPlanRepositoryInterface
{
...
class ReportDeliveryPlanRepository implements ReportDeliveryPlanRepositoryInterface
{
    public function create(array $data): DataModel
    {
