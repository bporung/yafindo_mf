...
use App\Models\ReportInventory as DataModel;
use Illuminate\Support\Collection;
use Auth;

interface ReportInventoryRepositoryInterface
{
...
class ReportInventoryRepository implements ReportInventoryRepositoryInterface
{
    public function create(array $data): DataModel
    {
