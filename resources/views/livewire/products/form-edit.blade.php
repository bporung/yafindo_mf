<div>
    <form  wire:submit.prevent="submitForm">
        ...
        <div class="text-sm my-3">
            ...
            <input type="text" name="nickname" wire:model="nickname" required placeholder="JD0012" class="w-full rounded border-gray-300 @error('nickname') border-red-500 @enderror">
