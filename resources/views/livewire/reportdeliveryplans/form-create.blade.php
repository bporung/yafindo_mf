<div>
    <form  wire:submit.prevent="submitForm">
        ...
        <div class="text-sm my-3">
            ...
            <input type="date" name="date" wire:model="date" required placeholder="JD0012" class="w-full rounded border-gray-300 @error('date') border-red-500 @enderror">
            @error('date') <span class="text-red-500">{{ $message }}</span> @enderror
        </div>
        <div class="text-sm my-3">
            <p class="font-light">The file's format must be 'csv' and the delimiter must be ';'.
            <a class="px-2 text-blue-400" href="/storage/sample-file/sample file - report delivery plan.zip">Download Sample File</a></p>
