<div>
    <form  wire:submit.prevent="submitForm">
        ...
        <div class="text-sm my-3">
            <label for="password" class="font-semibold">Password (make it empty if not updating):</label>
            <input type="text" name="password" wire:model="password" placeholder="Password" class="w-full rounded border-gray-300 @error('password') border-red-500 @enderror">
